...
from api.views.schools.branchs_viewsets import SchoolBranchViewSet
...
from api.views.schools.schools_api import SchoolAPIView, SchoolViewSet
from api.views.schools.schools_viewsets import (
    ...
    AddressViewSet,
    SchoolBranchContactInfoViewSet,
    SchoolBranchViewSet,
)
...
router.register(r"educational-levels", EducationalLevelViewSet, basename="educational-levels")
...
router.register(r"degree-offerings", SchoolDegreeOfferingViewSet, basename="degree-offerings")
router.register(r"college-associations", SchoolCollegeAssociationViewSet, basename="college-associations")
router.register(r"major-offerings", SchoolMajorOfferingViewSet, basename="major-offerings")
...
router.register(r"scholarship-types", ScholarshipTypeViewSet, basename="scholarship-types")
router.register(r"school-scholarships", SchoolScholarshipViewSet, basename="school-scholarships")
router.register(r"custom-buttons", SchoolCustomizeButtonViewSet, basename="custom-buttons")
router.register(r"addresses", AddressViewSet, basename="addresses")
router.register(r"school-contacts", SchoolBranchContactInfoViewSet, basename="contacts")
