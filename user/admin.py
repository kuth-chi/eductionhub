...
from .models import Attachment, Education, Experience, Profile, Letter, Hobby, Language, ProfileContact, Reference, Skill
...
class ProfileContactAdmin(admin.ModelAdmin):
    list_display = ("profile", "platform", "username", "profile_url", "is_active", "created_date")
